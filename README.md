...
```typescript
import { Application } from 'https://esm.sh/gh/doga/qgeminiserver@2.0.1/mod.mts';
...
```typescript
import { Application, serveStatic } from 'https://esm.sh/gh/doga/qgeminiserver@2.0.1/mod.mts';
...
import {
  ...
  handleRoutes,
  Route,
} from 'https://esm.sh/gh/doga/qgeminiserver@2.0.1/mod.mts'
